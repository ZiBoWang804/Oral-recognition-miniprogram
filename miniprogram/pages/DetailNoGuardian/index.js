...
// pages/DetailNoGuardian/index.js
Page({
  ...
  onShareAppMessage() {
    return {
      title: '儿童口腔检查详情',
      path: `/pages/DetailNoGuardian/index?id=${this.data._id}`
    }
  },
